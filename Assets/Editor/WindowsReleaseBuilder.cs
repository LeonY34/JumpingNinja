...
namespace JumpingNinjaEditor
{
    ...
    {
        private const string DefaultOutputPath = "Builds/JumpingNinja-v1.0.7-Windows/Jumping Ninja.exe";
        ...
        public static void Build()
        {
            ...
            if (PlayerSettings.bundleVersion != "1.0.7")
            {
                throw new InvalidOperationException("Windows release version must be v1.0.7.");
            }
