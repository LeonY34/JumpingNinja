...
namespace JumpingNinjaEditor
{
    ...
    {
        private const string DefaultOutputPath = "Builds/JumpingNinja-v1.0.3.apk";
        ...
        public static void BuildApk()
        {
            ...
            {
                throw new InvalidOperationException("Android release version must be v1.0.3 (version code 3).");
            }
